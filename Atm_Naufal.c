                    ...
                    case 5:
                        ...
                        switch (top_up_choice) {
							...
							case 6:
                                ...
                                printf("Masukan PIN: ");
                                scanf("%d", &pin);
                                printf("Isi Ulang Berhasil. Sisa Saldo Anda Saat Ini Adalah: %.2f", balance -= top_up_doku);
							case 7:
                                printf("Masukan Jumlah Yang Akan Di Isi Ulang: ");
                                scanf("%f", &top_up_sakuku);
                                printf("Masukan PIN: ");
                                scanf("%d", &pin);
                                printf("Isi Ulang Berhasil. Sisa Saldo Anda Saat Ini Adalah: %.2f", balance -= top_up_sakuku);
							case 8:
                                printf("Masukan Jumlah Yang Akan Di Isi Ulang: ");
                                scanf("%f", &top_up_linkaja);
                                printf("Masukan PIN: ");
                                scanf("%d", &pin);
                                printf("Isi Ulang Berhasil. Sisa Saldo Anda Saat Ini Adalah: %.2f", balance -= top_up_linkaja);							                           
